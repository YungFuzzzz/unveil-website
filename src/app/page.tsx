      ...
      <div className="text-center mt-12">
        ...
        <div className="flex justify-center mt-8 space-x-24">
          <div className="w-1/3">
            ...
            <p className="mt-2 text-left">Discover the poignant stories of the Holocaust in Mechelen. Experience history, honor the victims, and be moved by the power of remembrance.</p>
          </div>
          <div className="w-1/3">
            ...
            <p className="mt-2 text-left">From historic trade route to modern connector, discover how this river has shaped and reflected the city's story through the ages.</p>
          </div>
        </div>
      </div>
    </div>
